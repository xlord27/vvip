...
# https://raw.githubusercontent.com/xlord27/izinvps/main/ip 
...
echo ""
wget -q https://raw.githubusercontent.com/xlord27/VVIP/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/xlord27/VVIP/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/xlord27/VVIP/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
wget https://raw.githubusercontent.com/xlord27/VVIP/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
wget https://raw.githubusercontent.com/xlord27/VVIP/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/xlord27/VVIP/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
wget -q -O /tmp/nameserver "https://raw.githubusercontent.com/xlord27/abc/main/slowdns/nameserver" >/dev/null 2>&1
    chmod +x /tmp/nameserver
    bash /tmp/nameserver | tee /root/install.log
#wget https://raw.githubusercontent.com/xlord27/VVIP/main/slowdns/install-sldns.sh && chmod +x install-sldns.sh && ./install-sldns.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/xlord27/VVIP/main/update/update.sh && chmod +x update.sh && ./update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
cat> /root/.profile << END
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/xlord27/VVIP/main/version  )
